...
var quiz = function quiz() {
  ...
  var option1 = document.querySelector('.quiz__item_1'),
  ...
  var optionAll = document.querySelectorAll('.quiz__item'),
      //all question
  question = document.querySelector('.quiz__question'),
      //?? Question by itself
  currentNumber = document.querySelector('.quiz__current'),
      //in what quest we're now
  numberOfAllQustions = document.querySelector('.quiz__all'); //number of all question

  var answersTracker = document.querySelector('.quiz__indicator'); //Circle

  var btnNext = document.querySelector('.quiz__btn'); //Next btn

  var correctAnswer = document.querySelector('.modal__correct'),
      //in modal all correct ans
  globalNumber = document.querySelector('.modal__number'),
      //how many question was in quiz
  btnTry = document.querySelector('.modal__btn'); //

  var indexOfQuestion = 0,
      //in what question we are now
  indexOfPage = 0,
      //in what page we're now
  score = 0; // Result of quiz

  var questionArr = [{
    question: 'Как в Js вычилсть процент от числа?',
    options: ['Так в JS нельзя', 'Так в JS можно', 'Я не знаю', 'Пока'],
    rightAnswer: 1
  }, {
    question: 'Как в Js создать Function',
    options: ['Create Func', 'Я не знаю', 'function(e){}', 'Пока'],
    rightAnswer: 2
  }, {
    question: 'Как в Js создать перемую',
    options: ['let', 'var', 'const', 'Все варианты правильны'],
    rightAnswer: 3
  }]; //////////////////////////////////////////////////////////
  ...
  var load = function load(e) {
    if (indexOfPage != questionArr.length) {
      ...
      // Значить iгра закiнчилася ("Question 5 0f 5")
      endQuiz();
    }
  };
  ...
  var valid = function valid(e) {
    //If click on something and go to the next questin(if click was)
  ...
  var endQuiz = function endQuiz(e) {
    //modal show in the end
